      ...
      <el-scrollbar style="height: 100%">
        ...
        <div class="order-middle">
          <div class="user-info">
            <div class="user-info-box">
              ...
              >
                <label>{{
                  dialogOrderStatus === 5 ? 'Delivery Time:' : 'Expected Delivery Time'
                }}</label>
                <span>{{
                  dialogOrderStatus === 5
        ...
        <div class="order-bottom">
          <div class="amount-info">
            <div class="amount-label">Fees</div>
            <div class="amount-list">
              <div class="dish-amount">
                <span class="amount-name">Dish fees:</span>
              ...
              <div class="send-amount">
                <span class="amount-name">Delivery fees:</span>
                <span class="amount-price">${{ 6 }}</span>
              </div>
              <div class="package-amount">
                <span class="amount-name">Packing fees:</span>
                <span class="amount-price"
                  >${{
                    diaForm.packAmount
              ...
              <div class="all-amount">
                <span class="amount-name">In total:</span>
                <span class="amount-price"
                  >￥{{
                    diaForm.amount
