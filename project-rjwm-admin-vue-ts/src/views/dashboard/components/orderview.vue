<template>
  <div class="container">
    <h2 class="homeTitle">
      ...
      ><span><router-link to="/order">Details</router-link></span>
    </h2>
    <div class="orderviewBox">
      <ul>
        <li>
          <span class="status"
            ><i class="iconfont icon-waiting"></i>Pending Acceptance</span
          >
          <span class="num tip"
        ...
        <li>
          <span class="status"
            ><i class="iconfont icon-staySway"></i>Pending Dispatch</span
          >
          <span class="num tip"
