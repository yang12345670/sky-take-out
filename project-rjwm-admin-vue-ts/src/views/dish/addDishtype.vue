          ...
          <el-form-item>
            <div class="flavorBox">
              ...
              <div v-if="dishFlavors.length != 0"
                   class="flavor">
                <div class="title">
                  <span>title(within 3 words)</span>
        ...
        <div>
          <el-form-item label="Dish image:"
            ...
            <image-upload :prop-image-url="imageUrl"
              ...
              Image size less than 2M<br>only PNG JPEG JPG are supported<br>recommend to upload 200*200 or 300*300 size images
            </image-upload>
          </el-form-item>
        </div>
        <div class="address">
          <el-form-item label="Dish description:"
            ...
            <el-input v-model="ruleForm.description"
                      ...
                      :rows="3"
                      maxlength="200"
                      placeholder="Dish description, at most 200 words" />
          </el-form-item>
        </div>
...
export default class extends Vue {
  ...
  get rules() {
    return {
      name: [
        {
          ...
          validator: (rule: any, value: string, callback: Function) => {
            if (!value) {
              callback(new Error('Please input dish name'))
            } else {
      ...
      image: {
        required: true,
        message: 'dish image can\'t be empty '
      },
      price: [
        {
          required: true,
